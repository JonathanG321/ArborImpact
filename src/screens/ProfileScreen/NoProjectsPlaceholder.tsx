...
export default function NoProjectsPlaceholder() {
  ...
  return (
    <View className="flex mt-3 items-center">
      ...
      <Text className="text-xl mb-6 text-arbor-grey text-center">You don't have any projects yet!</Text>
      <Text className="text-xl mb-6 text-arbor-grey text-center">Click below to start browsing projects!</Text>
